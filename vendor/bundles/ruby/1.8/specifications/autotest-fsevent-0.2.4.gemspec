...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", ".rvmrc", "CHANGELOG.txt", "Gemfile", "Gemfile.lock", "LICENSE", "PostInstall.txt", "README.rdoc", "Rakefile", "autotest-fsevent.gemspec", "ext/fsevent/extconf.rb", "ext/fsevent/fsevent_sleep.c", "lib/autotest-fsevent.rb", "lib/autotest-fsevent/version.rb", "lib/autotest/fsevent.rb", "spec/autotest-fsevent_spec.rb", "spec/spec_helper.rb"]
